...
So, the mean of the total number of steps taken each day is about `r as.integer(step_mean)` and its median is `r as.integer(step_median)`.
...
So, the 5-minute interval that, on average, contains the maximum number of steps is the `r step_max` one.
...
The total number of missing values in the dataset is `r number_na[1]`. Note that it corresponds to what we have already seen when applying the summary function at the begining of the document.
